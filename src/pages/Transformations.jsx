...
const testimonials = [
  ...
  {
    text: "Je pratique YoGyFace depuis presque un an, après avoir essayé d'autres méthodes sans résultat. Mes sillons nasogéniens et ma ride du lion sont moins creusés, ma peau est repulpée et mon regard défatigué. Ma pratique est devenue un vrai moment de détente où j'ai repris confiance en moi. Je n'ai jamais vu un programme aussi complet : on est accompagnée de A à Z.",
    name: "Fanny",
    info: "47 ans · ~1 an · Sillons & ride du lion",
    initial: "F",
    link: "https://www.trustpilot.com/reviews/6a2b1c8f882a16df3f40b20f",
  },
  {
    text: "Bien plus efficace que les autres coachs en ligne ! Laury fait un vrai diagnostic adapté à notre visage, pas une appli identique pour toutes. En 3 mois, mes poches sont moins marquées, ma mâchoire plus lisse et ma ride du lion a quasi disparu grâce au taping. Être coachée par Laury m'a redonné confiance en moi : un visage plus détendu et plus jeune, sans chirurgie.",
    name: "Aurore",
    info: "3 mois · Poches, mâchoire & ride du lion",
    initial: "A",
    link: "https://www.trustpilot.com/reviews/6a2e78b79141ca5435afe805",
  },
  {
    text: "J'ai 45 ans et j'ai commencé en septembre. Après une lourde opération, je ne me reconnaissais plus : ride du lion marquée, pattes d'oie, rides horizontales, visage allongé. Grâce à la routine de Laury, j'ai détendu cervicales, trapèzes, masséters et tempes, retrouvé une meilleure posture — et mon visage s'est de nouveau arrondi. Les rides se sont estompées et je me sens beaucoup mieux.",
    name: "Virginie",
    info: "45 ans · Tensions & rides",
    initial: "V",
    link: "https://www.trustpilot.com/reviews/6a2ee612c96cedba939ad6a5",
  },
  {
    text: "J'ai 41 ans et je voyais mon visage changer sans savoir comment y répondre : ovale qui s'affaisse, regard fatigué, tensions à la mâchoire. Ce qui m'a convaincue, c'est le diagnostic sur mesure — une vraie ordonnance ciblée et expliquée, qu'on tient vraiment. Quelques semaines plus tard, l'ovale est plus tonique et mon regard plus ouvert. Et surtout, j'ai retrouvé une relation plus douce avec mon visage.",
    name: "Emmanuelle",
  ...
  {
    text: "J'ai 61 ans. Depuis 4 ans, je souffrais de douleurs à la mâchoire et au crâne malgré un suivi kiné. Dès les premières séances, elles se sont apaisées puis ont disparu — et ce bien-être perdure. Le diagnostic, l'ordonnance personnalisée et les retours réguliers sont d'une grande justesse. Je recommande sincèrement, pour son visage mais aussi pour retrouver détente et mieux-être.",
    name: "Christine",
    info: "61 ans · Mâchoire & bien-être",
    initial: "C",
