      ...
      <div className="max-w-[800px] mx-auto">
        ...
        <div className="space-y-10 text-[15px] text-gris leading-relaxed break-words">
          ...
          <div>
            ...
            <p>Le site www.yogyface.fr a pour objet la présentation et la commercialisation du programme numérique de yoga du visage « YoGyFace Studio », ainsi que la fourniture d'informations relatives à cette méthode de gymnastique faciale.</p>
          </div>
